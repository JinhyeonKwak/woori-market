...
public interface PostApi {
	...
	ResponseEntity<PostResponseDto> getPost(@PathVariable(value = "idx") Long idx);
	...
	@GetMapping("/v1/posts")
	ResponseEntity<Page<Post>> getPostList(@PageableDefault Pageable pageable);
	...
	ResponseEntity<CommentResponseDto> saveComment(@PathVariable Long idx, @RequestBody CommentRequestDto dto);
