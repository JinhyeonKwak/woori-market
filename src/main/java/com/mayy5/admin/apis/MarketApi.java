...
public interface MarketApi {
    ...
    @PostMapping(path = "/v1/markets/{marketId}/retailers/{retailerId}")
    ...
    @PatchMapping(path = "/v1/markets/{marketId}/retailers/{retailerId}")
    ...
    @GetMapping(path = "/v1/markets/retailers/{retailerId}")
